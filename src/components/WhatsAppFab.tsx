...
export function WhatsAppFab() {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/25 transition-transform hover:scale-105 active:scale-95 sm:bottom-5 sm:left-5 sm:right-auto sm:h-14 sm:w-14"
    >
